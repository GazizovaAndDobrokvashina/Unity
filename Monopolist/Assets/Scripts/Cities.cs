...
public static class Cities
{
    ...
    public static StreetPaths[] GetStreetPaths(City name)
    {
               ...
               pathes = new[]
        {
            ...
            case City.Tron:
                pathes = new[]
        {
          new StreetPaths {Renta = 25, NamePath = "Яблочная 1", IdStreetParent = 1, StartX = 159, StartY = -157, EndX = 0.5, EndY = -157, IsBridge = false}, 
          new StreetPaths {Renta = 20, NamePath = "Яблочная 2", IdStreetParent = 1, StartX = 0.5, StartY = -157, EndX = -51, EndY = -157, IsBridge = false}, 
          new StreetPaths {Renta = 30, NamePath = "Транспортная 1", IdStreetParent = 17, StartX = -51, StartY = -157, EndX = -104, EndY = -157, IsBridge = false}, 
          new StreetPaths {Renta = 25, NamePath = "Яблочная 3", IdStreetParent = 1, StartX = -104, StartY = -157, EndX = -156, EndY = -157, IsBridge = false},  
           
         new StreetPaths {Renta = 20, NamePath = "Томатная 1", IdStreetParent = 2, StartX = -156, StartY = -157, EndX = -156, EndY = -52, IsBridge = false},
           new StreetPaths {Renta = 25, NamePath = "Томатная 2", IdStreetParent = 2, StartX = -156, StartY = -52, EndX = -156, EndY = 0.5, IsBridge = false}, 
           new StreetPaths {Renta = 20, NamePath = "Томатная 3", IdStreetParent = 2, StartX = -156, StartY = 0.5, EndX = -156, EndY = 53, IsBridge = false}, 
           new StreetPaths {Renta = 20, NamePath = "Мандариновая 1", IdStreetParent = 3, StartX = -156, StartY = 53, EndX = -156, EndY = 157, IsBridge = false}, 
           
           new StreetPaths {Renta = 30, NamePath = "Мандариновая 2", IdStreetParent = 3, StartX = -156, StartY = 157, EndX = -51, EndY = 157, IsBridge = false}, 
           new StreetPaths {Renta = 30, NamePath = "Мандариновая 3", IdStreetParent = 3, StartX = -51, StartY = 157, EndX = 54, EndY = 157, IsBridge = false},
          new StreetPaths {Renta = 25, NamePath = "Мандариновая 4", IdStreetParent = 3, StartX = 54, StartY = 157, EndX = 106.5, EndY = 157, IsBridge = false},
          new StreetPaths {Renta = 20, NamePath = "Морская 1", IdStreetParent = 4, StartX = 106.5, StartY = 157, EndX = 159, EndY = 157, IsBridge = false},
            
           new StreetPaths {Renta = 25, NamePath = "Морская 2", IdStreetParent = 4, StartX = 159, StartY = 157, EndX = 159, EndY = 53, IsBridge = false},
           new StreetPaths {Renta = 25, NamePath = "Морская 3", IdStreetParent = 4, StartX = 159, StartY = 53, EndX = 159, EndY = -52, IsBridge = false},
           new StreetPaths {Renta = 30, NamePath = "Коммунальная 1", IdStreetParent = 18, StartX = 159, StartY = -52, EndX = 159, EndY = -103.5, IsBridge = false},
           new StreetPaths {Renta = 20, NamePath = "Морская 4", IdStreetParent = 4, StartX = 159, StartY = -103.5, EndX = 159, EndY = -157, IsBridge = false},
            
          new StreetPaths {Renta = 20, NamePath = "Сретенка 1", IdStreetParent = 5, StartX = 159, StartY =-103.5, EndX = 54, EndY = -103.5, IsBridge = true},
           new StreetPaths {Renta = 20, NamePath = "Сретенка 2", IdStreetParent = 5, StartX = 54, StartY = -103.5, EndX = 0.5, EndY = -103.5, IsBridge = true},
            
           new StreetPaths {Renta = 20, NamePath = "Баклажановая 1", IdStreetParent = 6, StartX = 159, StartY = -52, EndX = 106.5, EndY = -52, IsBridge = true},
           new StreetPaths {Renta = 20, NamePath = "Баклажановая 2", IdStreetParent = 6, StartX = 106.5, StartY = -52, EndX = 54, EndY = -52, IsBridge = true},
           new StreetPaths {Renta = 20, NamePath = "Баклажановая 3", IdStreetParent = 6, StartX = 54, StartY = -52, EndX = 0.5, EndY = -52, IsBridge = true},
           new StreetPaths {Renta = 40, NamePath = "БэтУлица 1", IdStreetParent = 7, StartX = 0.5, StartY = -52, EndX = -51, EndY = -52, IsBridge = true},
           new StreetPaths {Renta = 40, NamePath = "БэтУлица 2", IdStreetParent = 7, StartX = -51, StartY = -52, EndX = -104, EndY = -52, IsBridge = true},
           new StreetPaths {Renta = 40, NamePath = "БэтУлица 3", IdStreetParent = 7, StartX = -104, StartY = -52, EndX = -156, EndY = -52, IsBridge = true},
            
           new StreetPaths {Renta = 20, NamePath = "Горная 1", IdStreetParent = 8, StartX = 106.5, StartY = 0.5, EndX = 54, EndY = 0.5, IsBridge = true},
           new StreetPaths {Renta = 25, NamePath = "Горная 2", IdStreetParent = 8, StartX = 54, StartY = 0.5, EndX = 0.5, EndY = 0.5, IsBridge = true},
           new StreetPaths {Renta = 30, NamePath = "Коммунальная 2", IdStreetParent = 18, StartX = 0.5, StartY = 0.5, EndX = -51, EndY = 0.5, IsBridge = true},
           new StreetPaths {Renta = 20, NamePath = "Орная 1", IdStreetParent = 9, StartX = -51, StartY = 0.5, EndX = -104, EndY = 0.5, IsBridge = true},
           new StreetPaths {Renta = 25, NamePath = "Орная 2", IdStreetParent = 9, StartX = -104, StartY = 0.5, EndX = -156, EndY = 0.5, IsBridge = true},
          
          new StreetPaths {Renta = 25, NamePath = "Угандовая 1", IdStreetParent = 10, StartX = 159, StartY = 53, EndX = 106.5, EndY = 53, IsBridge = true},
           new StreetPaths {Renta = 25, NamePath = "Угандовая 2", IdStreetParent = 10, StartX = 106.5, StartY = 53, EndX = 54, EndY = 53, IsBridge = true},
           new StreetPaths {Renta = 25, NamePath = "Угандовая 3", IdStreetParent = 10, StartX = 54, StartY = 53, EndX = 0.5, EndY = 53, IsBridge = true},
           new StreetPaths {Renta = 25, NamePath = "Вакандовая 1", IdStreetParent = 11, StartX = 0.5, StartY = 53, EndX = -51, EndY = 53, IsBridge = true},
           new StreetPaths {Renta = 25, NamePath = "Вакандовая 2", IdStreetParent = 11, StartX = -51, StartY = 53, EndX = -156, EndY = 53, IsBridge = true},  
           
           new StreetPaths {Renta = 20, NamePath = "Угольная 1", IdStreetParent = 12, StartX = -104, StartY = -157, EndX = -104, EndY = -52 , IsBridge = false}, 
           new StreetPaths {Renta = 20, NamePath = "Угольная 2", IdStreetParent = 12, StartX = -103, StartY = -52, EndX = -104, EndY = 0.5, IsBridge = false},
            
           new StreetPaths {Renta = 20, NamePath = "Виноградная 1", IdStreetParent = 13, StartX = -51, StartY = -157, EndX = -51, EndY = -52, IsBridge = false},
           new StreetPaths {Renta = 20, NamePath = "Виноградная 2", IdStreetParent = 13, StartX = -51, StartY = -52, EndX = -51, EndY = 0.5, IsBridge = false},
           new StreetPaths {Renta = 20, NamePath = "Виноградная 3", IdStreetParent = 13, StartX = -51, StartY = 0.5, EndX = -51, EndY = 53, IsBridge = false},
           new StreetPaths {Renta = 30, NamePath = "Транспортная 2", IdStreetParent = 17, StartX = -51, StartY = 53, EndX = -51, EndY = 157, IsBridge = false},
            
           new StreetPaths {Renta = 50, NamePath = "ТМовская 1", IdStreetParent = 14, StartX = 0.5, StartY = 53, EndX = 0.5, EndY = 0.5, IsBridge = false},
           new StreetPaths {Renta = 50, NamePath = "ТМовская 2", IdStreetParent = 14, StartX = 0.5, StartY = 0.5, EndX = 0.5, EndY = -52, IsBridge = false},
           new StreetPaths {Renta = 50, NamePath = "ТМовская 3", IdStreetParent = 14, StartX = 0.5, StartY = -52, EndX = 0.5, EndY = -103.5, IsBridge = false},
           new StreetPaths {Renta = 50, NamePath = "ТМовская 4", IdStreetParent = 14, StartX = 0.5, StartY = -103.5, EndX = 0.5, EndY = -157, IsBridge = false},     
          
           new StreetPaths {Renta = 40, NamePath = "Единороговая 1", IdStreetParent = 15, StartX = 54, StartY = 157, EndX = 54, EndY = 53, IsBridge = false},        
          new StreetPaths {Renta = 40, NamePath = "Единороговая 2", IdStreetParent = 15, StartX = 54, StartY = 53, EndX = 54, EndY = 0.5, IsBridge = false},
           new StreetPaths {Renta = 40, NamePath = "Единороговая 3", IdStreetParent = 15, StartX = 54, StartY = 0.5, EndX = 54, EndY = -52, IsBridge = false},
           new StreetPaths {Renta = 40, NamePath = "Транспортная 3", IdStreetParent = 17, StartX = 54, StartY = -52, EndX = 54, EndY = -103.5, IsBridge = false},
           
           new StreetPaths {Renta = 20, NamePath = "Седановая 1", IdStreetParent = 16, StartX = 106.5, StartY = 157, EndX = 106.5, EndY = 53, IsBridge = false},
           new StreetPaths {Renta = 20, NamePath = "Седановая 2", IdStreetParent = 16, StartX = 106.5, StartY = 53, EndX = 106.5, EndY = 0.5, IsBridge = false},
           new StreetPaths {Renta = 20, NamePath = "Седановая 3", IdStreetParent = 16, StartX = 106.5, StartY = 0.5, EndX = 106.5, EndY = -52, IsBridge = false}
        };
                break;
        }
    ...
    public static Builds[] GetBuildses(City name)
    {
                ...
                buildses = new[]
        {
            ...
            new Builds {NameBuild = "Дом на ТМовской 2.1", AboutBuild = "Дом Юхмана", Enabled = false, IdStreetPath = 42, PriceBuild = 100, posX = -4, posY = 0},
            new Builds {NameBuild = "Дом на ТМовской 2.2", AboutBuild = "Дом Кем", Enabled = false, IdStreetPath = 42, PriceBuild = 100, posX = -4, posY = 4.5},
            
            new Builds {NameBuild = "Дом на ТМовской 3.1", AboutBuild = "Дом Дехан", Enabled = false, IdStreetPath = 43, PriceBuild = 100, posX = -4, posY = 0},
            new Builds {NameBuild = "Дом на ТМовской 3.2", AboutBuild = "Дом Бертон", Enabled = false, IdStreetPath = 43, PriceBuild = 100, posX = -4, posY = 4.5},            
            new Builds {NameBuild = "Дом на ТМовской 3.3", AboutBuild = "Дом Леры", Enabled = false, IdStreetPath = 43, PriceBuild = 100, posX = -4, posY = 0},
